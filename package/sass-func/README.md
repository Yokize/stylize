...
[![deps](https://img.shields.io/librariesio/release/npm/@stylize/sass-func?style=flat-square)](https://github.com/Yokize/stylize/actions/workflows/CI.yml)
...
[![MIT](https://img.shields.io/npm/l/@stylize/sass-func?style=flat-square&color=blue)](https://en.wikipedia.org/wiki/MIT_License)
